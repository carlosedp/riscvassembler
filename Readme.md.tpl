...
```scala
// Import libraries
libraryDependencies += "com.carlosedp" %% "riscvassembler" % "{{.LastRelease}}"
```
...
// Add to your ivyDeps
def ivyDeps = Agg(
  ivy"com.carlosedp::riscvassembler:{{.LastRelease}}"
  ...
)
```
...
libraryDependencies += "com.carlosedp" %% "riscvassembler" % "{{.LastSnapshot}}"
```
...
def ivyDeps = Agg(
  ivy"com.carlosedp::riscvassembler:{{.LastSnapshot}}"
  ...
)
```
