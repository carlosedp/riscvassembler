...
```scala
// Import libraries
libraryDependencies += "com.carlosedp" %% "riscvassembler" % "1.7.0"  //ReleaseVerSBT
```
...
// Add to your ivyDeps
def ivyDeps = Agg(
  ivy"com.carlosedp::riscvassembler:1.7.0"  //ReleaseVerMill
  ...
)
```
...
libraryDependencies += "com.carlosedp" %% "riscvassembler" % "1.8-SNAPSHOT"  //SnapshotVerSBT
```
...
def ivyDeps = Agg(
  ivy"com.carlosedp::riscvassembler:1.8-SNAPSHOT"  //SnapshotVerMill
  ...
)
```
